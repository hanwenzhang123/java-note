...
//Assigned variable to the function 
public class Main {
    public static void main(String[] args) {
        boolean gameOver = true;
        int score = 800;
        ...
        int highScore = calculateScore(gameOver, score, levelCompleted, bonus);     //the result sent back from the finalScore in the calculateScore() below
        ...
        highScore = calculateScore(gameOver, score, levelCompleted, bonus);     //the result sent back from the finalScore in the calculateScore() below
        System.out.println("Your final score was " + highScore);
    }
